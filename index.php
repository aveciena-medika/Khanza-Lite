...
<?php if (!$getmodule) { ?>
    <section class="content">
        <div class="container-fluid">
                    ...
                    <div class="info-box bg-pink hover-expand-effect">
                        ...
                        <div class="content">
                            ...
                            <div class="number count-to" data-from="0"
                                 data-to="<?php echo num_rows(query("SELECT no_rkm_medis FROM pasien")); ?>"
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-cyan hover-expand-effect">
                        ...
                        <div class="content">
                            ...
                            <div class="number count-to" data-from="0"
                                 data-to="<?php echo num_rows(query("SELECT no_rkm_medis FROM pasien WHERE tgl_daftar LIKE '%$month%'")); ?>"
                                 data-speed="1000" data-fresh-interval="20"></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-light-green hover-expand-effect">
                        ...
                        <div class="content">
                            ...
                            <div class="number count-to" data-from="0"
                                 data-to="<?php echo num_rows(query("SELECT no_rawat FROM reg_periksa WHERE tgl_registrasi LIKE '%$month%'")); ?>"
                                 data-speed="1000" data-fresh-interval="20"></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-orange hover-expand-effect">
                        ...
                        <div class="content">
                            ...
                            <div class="number count-to" data-from="0"
                                 data-to="<?php echo num_rows(query("SELECT no_rawat FROM reg_periksa WHERE tgl_registrasi LIKE '%$date%'")); ?>"
                                 data-speed="1000" data-fresh-interval="20"></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row clearfix">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pull-left pd0">
                    <div class="card">
                        <div class="header">
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 pull-left pd0">
                    <div class="card">
                        ...
                        <div class="setting-con"
                             style="padding:0; height:381px; margin-right: -4px; overflow: hidden;overflow-y:scroll">
