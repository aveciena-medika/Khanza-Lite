<section>
    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="user-info">
            ...
            <a href="javascript:void(0);" id="sticky" style="text-decoration: none;color: #ffffff;float: right"
               class="pin"><i class="material-icons">lock</i></a>
            <div class="info-container">
                <div class="name" data-toggle="dropdown" aria-haspopup="true"
                     aria-expanded="false"><?php echo $dataGet['nama']; ?></div>
                <div class="email"><?php echo $_SESSION['username']; ?>
                    | <?php echo $role; ?> <?php if ($_SESSION['jenis_poli'] !== "") {
                        echo ' | ' . $_SESSION['jenis_poli'];
                    } ?> </div>
                <div class="btn-group user-helper-dropdown">
                    ...
                    <ul class="dropdown-menu pull-right">
                        ...
                        <li><a href="<?php echo URL; ?>/login.php?action=logout"><i class="material-icons">input</i>Sign
                                Out</a></li>
                    </ul>
                </div>
            </div>
        ...
        <div class="legal">
            <div class="copyright">
                &copy; 2017 - <?php echo date('Y'); ?> <a href="#" data-toggle="modal" data-target="#ICTRSHD">Instalasi
                    ICT RSHD</a>. v <?php echo VERSION; ?>
            </div>
        </div>
        <!-- #Footer -->
    </aside>
